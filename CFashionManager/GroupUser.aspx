<%@ Page Title="Danh mục nhóm người dùng" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="GroupUser.aspx.cs" Inherits="GroupUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" Runat="Server">
   ...
   <div class="row">
      ...
      <section class="">
   <div class="pull-left">
      <h3 style="margin:5px; font-weight:bold;"><i class="fa fa-users"></i> Danh mục nhóm người dùng</h3>
   </div>
   <div style="text-align:right; padding-bottom:10px;">
    <a href="#" onclick="addColor();" class="btn btn-sm btn-success" data-toggle="modal" data-target="#addGroupUser"><i class="glyphicon glyphicon glyphicon-edit"></i> Thêm nhóm người dùng</a>
      <div class="dropdown">
...
<div class="modal fade" id="addGroupUser" role="dialog">
            ...
            <div class="modal-content" style="font-size: 12px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title center">
                        ...
                        <span id="lb">THÊM NHÓM NGƯỜI DÙNG</span>
                    </h4>
                </div>
                <div class="modal-body">
                    <div class="row" style="padding: 5px;">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">Tên nhóm<br />
    ...
    <script type="text/javascript">
        function updateGroupUser_modal(id, branchtypeId, branchTypeName, code, name) {
            $("#addGroupUser").modal({ show: false });
            $('#hdColorId').val(id);
            $('#txtCode').val(code);
            $('#txtName').val(name);
            ...
            $('#removeColor').show();
            document.getElementById('lb').innerText = 'CẬP NHẬT NHÓM NGƯỜI DÙNG';
        }
        function addColor() {
            $("#addGroupUser").modal({ show: false });
            $('#hdColorId').val('');
            ...
            $('#txtName').val('');
            $('#removeColor').hide();
            document.getElementById('lb').innerText = 'THÊM NHÓM NGƯỜI DÙNG';
        }
        function saveChanges() {
            ...
            if (id == '') {
                ...
                if (code != '' && name != '') {
                    $.ajax({
                        type: 'POST',
                        url: '/Command.aspx/insertGroupUser',
                        data: '{"branchTypeId":"' + branchType + '","code":"' + code + '","name":"' + name + '"}',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        success: function (data) {
                            if (data.d._content == '1') {
                                showAlert('Đã thêm nhóm người dùng [' + name + ']');
                ...
                else showAlert('Nhập mã và tên nhóm');
            }
            else {
                updateChanges();
            }
        ...
        function updateChanges() {
            ...
            if (code != '' && name != '') {
                $.ajax({
                    type: 'POST',
                    url: '/Command.aspx/updateGroupUser',
                    ...
                    success: function (data) {
                        if (data.d._content == '1') {
                            ...
                            showAlert('Đã cập nhật nhóm người dùng [' + name + ']');
        ...
        function deleteColor() {
            ...
            if (confirm("Bạn chắc chắn muốn xóa [" + name + "] ?") == true) {
                if (id != '') {
                    $.ajax({
                        type: 'POST',
                        url: '/Command.aspx/deleteGroupUser',
                        data: '{"id":"' + id + '"}',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        success: function (data) {
                            if (data.d._content == '1') {
                                ...
                                $('#delete' + id).remove();
                                showAlert('Đã xóa nhóm [' + name + ']');
                                $("#addGroupUser").modal('hide');
                            }
                            else
                                showAlert(data.d._mess);
                        }
                ...
                else showAlert('Chọn nhóm muốn xóa');
            }
        }
    </script>
</asp:Content>
