<%@ Page Title="Danh mục đơn vị tính" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Unit.aspx.cs" Inherits="Unit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" Runat="Server">
   ...
   <div class="row">
      ...
      <section class="">
   <div class="pull-left">
      <h3 style="margin:5px; font-weight:bold;"><i class="fa fa-hourglass-end"></i> Danh mục đơn vị tính</h3>
   </div>
   <div style="text-align:right; padding-bottom:10px;">
    <a href="#" onclick="addColor();" class="btn btn-sm btn-success" data-toggle="modal" data-target="#addColor"><i class="glyphicon glyphicon glyphicon-edit"></i> Thêm đơn vị tính</a>
      <div class="dropdown">
      <button class="btn btn-sm btn-danger dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-th"></i> Hiển thị</button>
        <ul class="dropdown-menu ul-column" style="margin-left:-65px;">
            <li><a href="#" class="small toggle-vis" data-column="1" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Mã đơn vị tính</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="2" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Tên đơn vị tính</label> </a></li>
                ...
                <table id="example2" class="table hover cell-border" style="min-width:1050px; font-size:12px;">
                  <thead>
                     <tr>
                        ...
                        <th class="bg-th">Mã đơn vị tính</th>
                        <th class="bg-th">Tên đơn vị tính</th>
...
<div class="modal fade" id="addColor" role="dialog">
            ...
            <div class="modal-content" style="font-size: 12px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title center">
                        ...
                        <span id="lb">THÊM ĐƠN VỊ TÍNH</span>
                    </h4>
                </div>
                <div class="modal-body">
                    <div class="row" style="padding: 5px;">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">Tên đơn vị tính<br />
    ...
    <script type="text/javascript">
        function updateColor_modal(id, branchtypeId, branchTypeName, code, name) {
            ...
            $('#removeColor').show();
            document.getElementById('lb').innerText = 'CẬP NHẬT ĐƠN VỊ TÍNH';
        }
        function addColor() {
            $("#addColor").modal({ show: false });
            $('#hdColorId').val('');
            ...
            $('#txtName').val('');
            $('#removeColor').hide();
            document.getElementById('lb').innerText = 'THÊM ĐƠN VỊ TÍNH';
        }
        function saveChanges() {
            ...
            if (id == '') {
                ...
                else showAlert('Nhập mã và tên đơn vị tính');
            }
            else {
                updateChanges();
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.d._content == '1') {
                            ...
                            showAlert('Đã cập nhật đơn vị tính [' + name + ']');
        ...
        function deleteColor() {
            ...
            if (confirm("Bạn chắc chắn muốn xóa [" + name + "] ?") == true) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.d._content == '1') {
                                $('#hdColorId').val('');
                                $('#delete' + id).remove();
                                showAlert('Đã xóa đơn vị tính [' + name + ']');
                                $("#addColor").modal('hide');
                            }
                            else
                                showAlert(data.d._mess);
                ...
                else showAlert('Chọn đơn vị tính muốn xóa');
            }
        }
    </script>
</asp:Content>
