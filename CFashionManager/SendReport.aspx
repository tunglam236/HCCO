<%@ Page Title="Cấu hình gửi báo cáo" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="SendReport.aspx.cs" Inherits="SendReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
   ...
   <div class="row">
      ...
      <section class="">
   <div class="pull-left">
      <h3 style="margin:5px; font-weight:bold;"><i class="fa fa-envelope-o"></i> Thiết lập gửi email báo cáo</h3>
   </div>
