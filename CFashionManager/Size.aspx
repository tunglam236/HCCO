<%@ Page Title="Danh mục Size" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Size.aspx.cs" Inherits="Size" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" Runat="Server">
   ...
   <div class="row">
      ...
      <section class="">
   <div class="pull-left">
      <h3 style="margin:5px; font-weight:bold;"><i class="fa fa-scissors"></i> Danh mục size</h3>
   </div>
   <div style="text-align:right; padding-bottom:10px;">
    <a href="#" onclick="addColor();" class="btn btn-sm btn-success" data-toggle="modal" data-target="#addColor"><i class="glyphicon glyphicon glyphicon-edit"></i> Thêm size</a>
      <div class="dropdown">
      <button class="btn btn-sm btn-danger dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-th"></i> Hiển thị</button>
        <ul class="dropdown-menu ul-column" style="margin-left:-65px;">
            <li><a href="#" class="small toggle-vis" data-column="1" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Mã size</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="2" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Tên size</label> </a></li>
                ...
                <table id="example2" class="table hover cell-border" style="min-width:1050px; font-size:12px;">
                  <thead>
                     <tr>
                        ...
                        <th class="bg-th">Mã size</th>
                        <th class="bg-th">Tên size</th>
...
<div class="modal fade" id="addColor" role="dialog">
                ...
                <div class="modal-body">
                    <div class="row" style="padding: 5px;">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">Tên size<br />
    ...
    <script type="text/javascript">
        function updateColor_modal(id, branchtypeId, branchTypeName, code, name) {
            ...
            $('#removeColor').show();
            document.getElementById('lb').innerText = 'CẬP NHẬT SIZE';
        }
        function addColor() {
            $("#addColor").modal({ show: false });
            $('#hdColorId').val('');
            ...
            $('#txtName').val('');
            $('#removeColor').hide();
            document.getElementById('lb').innerText = 'THÊM SIZE';
        }
        function saveChanges() {
            ...
            if (id == '') {
                ...
                else showAlert('Nhập mã và tên size');
            }
            else {
                updateChanges();
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.d._content == '1') {
                            ...
                            showAlert('Đã cập nhật size [' + name + ']');
        ...
        function deleteColor() {
            ...
            if (confirm("Bạn chắc chắn muốn xóa [" + name + "] ?") == true) {
                ...
                else showAlert('Chọn size muốn xóa');
            }
        }
    </script>
</asp:Content>
