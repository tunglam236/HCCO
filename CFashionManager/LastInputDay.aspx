<%@ Page Title="Báo cáo nhập hàng" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="LastInputDay.aspx.cs" Inherits="LastInputDay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
   ...
   <div class="row">
      ...
      <section class="">
       <div class="pull-left">
          <h3 style="margin:5px; font-weight:bold;"><i class="fa fa-sign-in"></i> Báo cáo nhập hàng</h3>
       </div>
       <div style="text-align:right; padding-bottom:10px;">
          ...
          <button class="btn btn-sm btn-danger dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-th"></i> Hiển thị</button>
            ...
            <li><a href="#" class="small toggle-vis" data-column="4" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;NV Nhập</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="5" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Số phiếu</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="6" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Mã vạch</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="7" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Mã hàng</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="8" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Tên hàng</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="9" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Số lượng</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="10" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Đơn vị tính</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="11" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Mã NCC</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="12" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Tên NCC</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="13" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Địa chỉ</label> </a></li>
        ...
        <div class="box box-warning">
            ...
            <table id="example2" class="table hover cell-border" style="font-size:12px;min-width:2200px;">
                  <thead>
                        <tr>
                        <th colspan="6" class="center" style="border:1px solid #ccc;">Thông tin phiếu nhập</th>
                        <th colspan="5" class="center" style="border:1px solid #ccc;">Thông tin sản phẩm</th>
                       <th colspan="4" class="center" style="border:1px solid #ccc;">Thông tin nhà cung cấp</th>
                    </tr>
                      <tr>
                        <th class='bg-th center' width="40px"></th>
                        <th class="bg-th">Mã CN</th>
                        <th class="bg-th">Tên CN</th>
                         ...
                         <th class="bg-th">Mã NCC</th>
                         <th class="bg-th">Tên NCC</th>
                  ...
                  <tfoot>
                     <tr>
                      ...
                      <tr>
                          <th colspan="9" class="right" style="border:1px solid #ccc;">Tổng số lượng</th>
                          <th colspan="6" class="left" style="border:1px solid #ccc;"> <asp:Literal ID="lbCount" runat="server"></asp:Literal></th>
                      </tr>
                  </tfoot>
               </table>
            </div>
