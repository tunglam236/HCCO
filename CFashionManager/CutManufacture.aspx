<%@ Page Title="Cắt sản xuất" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="CutManufacture.aspx.cs" Inherits="CutManufacture" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" Runat="Server">
   ...
   <div class="row">
        ...
        <div class="panel panel-success">
          ...
          <div class="panel-collapse" style="padding:5px;">
              <asp:RadioButtonList ID="rdStatus" CssClass="rdList" runat="server" RepeatDirection="Vertical">
                  ...
                  <asp:ListItem Text="Chưa cắt" Value="1"></asp:ListItem>
                  <asp:ListItem Text="Đã cắt" Value="2"></asp:ListItem>
              </asp:RadioButtonList>
      ...
      <section class="">
   <div class="pull-left">
      <h3 style="margin:5px; font-weight:bold;"><i class="fa fa-cut"></i> Cắt sản xuất</h3>
   </div>
   <div style="text-align:right; padding-bottom:10px;">
      ...
      <button class="btn btn-sm btn-danger dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-th"></i> Hiển thị</button>
        <ul class="dropdown-menu ul-column" style="margin-left:-65px;">
            ...
            <li><a href="#" class="small toggle-vis" data-column="2" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Ngày cắt</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="3" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Người cắt</label> </a></li>
 ...
 <div class="modal fade" id="addDept" role="dialog">
                ...
                <div class="modal-body">
                    <div class="row" style="padding: 5px;">
                     ...
                     <div class="row">
                            <div class="col-md-12">
                            Ghi chú<br />
                                <input type="text" id="txtNote" class="form-control" maxlength="128" style="width: 100%;" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 5px;">
                          <span class="btn-group">
                              <button type="button" class="approved btn btn-sm btn-primary" onclick="complete();">Hoàn thành cắt mẫu</button>
    ...
    <script type="text/javascript">
        ...
        function complete() {
            ...
            var date = $('#txtCreateAt').val();
            var note = $('#txtNote').val();

            if (date == '') showAlert('Nhập ngày hoàn thành cắt mẫu');
            else {
                if (confirm("Bạn chắc chắn đã hoàn thành mẫu này ?") == true) {
                    $.ajax({
                        type: 'POST',
                        url: '/Command.aspx/updateCutManufacture',
                        data: '{"formId":"' + formId + '","date":"' + date + '","note":"' + note + '"}',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        success: function (data) {
                            if (data.d._content == '1') {
                                showAlert('Đã lưu hoàn thành cắt mẫu');
                                setTimeout(function () {
