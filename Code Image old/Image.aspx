...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
   ...
   <div style="text-align:right; padding-bottom:10px;">
       <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#showModalAddImage"><i class="glyphicon glyphicon glyphicon-edit"></i> Thêm mã mới</a>
       <div class="dropdown">
        ...
        <ul class="dropdown-menu ul-column" style="margin-left:-65px;">
            <li><a href="#" class="small toggle-vis" data-column="1" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Mã sản phẩm</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="2" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Ảnh lớn</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="3" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Ảnh nhỏ</label> </a></li>
            <li><a href="#" class="small toggle-vis" data-column="4" tabIndex="-1"><label><input type="checkbox" checked/>&nbsp;Số lượng ảnh</label> </a></li>
        </ul>
    </div>
</section>
                  ...
                  <thead>
                     <tr>
                        ...
                        <th class="bg-th">Mã sản phẩm</th>
                         <th class="bg-th">Ảnh lớn</th>
                         <th class="bg-th">Ảnh nhỏ</th>
            ...
            <div class="modal-content" style="font-size: 12px;">
                ...
                <div class="modal-body">
                    <div class="row" style="padding: 5px;">
                        <div class="col-md-3">
                            Chọn chuỗi<br />
                            <select id="dlBranchType" onchange="loadProductTypeByBranchType($(this).val())" class="form-control select2" style="width: 100%;">
                            </select>
                        </div>
                        <div class="col-md-3">
                            Mã sản phẩm<br />
                            <select id="dlProductTypeCode" class="form-control select2" style="width: 100%;">
                            </select>
                        </div>
                        <div class="col-md-3">
                            Ảnh lớn<br />
    ...
    <asp:HiddenField ID="hdProductTypeCode" runat="server" Value="" />
    <asp:HiddenField ID="hdBranchType" runat="server" Value="" />
    <script>
        var options = ["1", "2", "3", "4"];
    ...
    <script>
     ...
     <script type="text/javascript">
         $(document).ready(function () {
             $('#dlBranchType').find('option').remove().end();
             $.ajax({
                 type: 'POST',
                 ...
                 success: function (data) {
                     ...
                     loadProductTypeByBranchType($('#dlBranchType').val());
                 }
             });
        });
    </script>
    <script type="text/javascript">
        function loadProductTypeByBranchType(branchtype) {
            $('#dlProductTypeCode').find('option').remove().end();

            $.ajax({
                type: 'POST',
                url: '/Command.aspx/loadProductTypeCodeImage',
                data: '{"branchType":"' + branchtype + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (data) {
                    var c1 = document.getElementById('dlProductTypeCode');
                    for (var i = 0; i < data.d.length; i++) {
                        var opt = document.createElement('option');
                        opt.value = data.d[i]._content;
       ...
       function getFilter() {
            ...
            var branchType = $('input[name="ctl00$cph$rdBranchType"]:checked').val();
            $('#cph_hdProductTypeCode').val($('#dlProductTypeCode').val());
            $('#cph_hdBranchType').val($('#dlBranchType').val());
