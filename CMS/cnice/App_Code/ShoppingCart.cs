...
public class ShoppingCart : DataTable
{
    ...
    public void AddProduct(string ID, string code, string procode, string proname, string image, int quantity, double price, double pricesale, double score, string brand, string countryname, bool sale)
    {
