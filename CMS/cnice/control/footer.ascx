                     ...
                     <div class="container-inner">
                        ...
                        <div class="follow">
                           ...
                           <ul class="link-follow">
                              <li class="first"><a class="twitter icon ion-social-instagram" title="Instagram" href="http://instagram.com/cnicevn"><span>Instagram</span></a></li>
                              <li><a class="google icon ion-social-googleplus" title="Google" href="javascript:void(0)"><span>google</span></a></li>
                              <li><a class="facebook icon ion-social-facebook" title="Facebook" href="http://facebook.com/cnicevn"><span>facebook</span></a></li>
                        ...
                        <div class="col-md-4 col-sm-6 col-footer">
                           <div class="footer-content">
                              <div class="footer-contact">
                                 <a class="logo-footer" href="/home"><img src="/image/CNICE-logo.png" alt="img"></a>
                                 <p><strong><i class="fa fa-home"></i> Địa chỉ cửa hàng:</strong>73 Cầu Giấy - Hà Nội.</p>
                                 <p><strong><i class="fa fa-phone"></i> Hotline:</strong>(+8424) 22 15 73 73</p>
                                 <p><strong><i class="fa fa-envelope"></i> Email:</strong>info@hcco.vn</p>
                                  <p><strong><i class="fa fa-globe"></i> Website:</strong><a href="http://cnice.vn" target="_blank">http://cnice.vn</a> </p>
                                  <p><strong><i class="fa fa-facebook-square"></i> Facebook:</strong><a href="http://facebook.com/cnicevn" target="_blank">http://facebook.com/cnicevn</a> </p>
                                  <p><strong><i class="fa fa-instagram"></i> Instagram:</strong><a href="http://instagram.com/cnicevn" target="_blank">http://instagram.com/cnicevn</a> </p>
                              </div>
                           </div>
                        </div>
                     </div>
