    ...
    <div class="oc-banner7-container">
        <div class="flexslider oc-nivoslider">
            ...
            <div id="oc-inivoslider" class="slides">
                <a href="#">
                    <img style="display: none;" src="/upload/slider/slide1.png"
                        alt="" title="#banner7-caption1" /></a> 
                <a href="#">
                   <img style="display: none;" src="/upload/slider/slide2.png"
                                alt="" title="#banner7-caption2" /></a>
                <a href="#"><img style="display: none;" src="/upload/slider/slide3.png"
                                alt="" title="#banner7-caption3" /></a>
                <a href="#"><img style="display: none;" src="/upload/slider/banner-2.jpg"
                                alt="" title="#banner7-caption1" /></a>
                <a href="#"><img style="display: none;" src="/upload/slider/banner-3.jpg"
                                alt="" title="#banner7-caption2" /></a>
            </div>
                    ...
                    <div class="container" style="height: 100%;">
                        <div class="container-inner" style="height: 100%; width: 100%; position: relative;">
                            <div class="text-content">
                                <h1 class="title1">
                                    C'Nice <span>Grand Opening</span></h1>
                                <h2 class="sub-title">
                                    Comming Soon 12/2017</h2>
                ...
                <div class="banner7-content slider-2">
                    <div class="container" style="height: 100%;">
                        <div class="container-inner" style="height: 100%; width: 100%; position: relative;">
                            <div class="text-content">
                                <h1 class="title1">
                                    Free shipping beauty</h1>
                                <div class="banner7-des">
                                    <p>
                                        Shop Top Quality Haircare, Makeup, Skincare, Nailcare &amp; Much More.</p>
                                </div>
                                <div class="banner7-readmore">
                                    <a href="#" title="shop now">View Collection</a>
                                </div>
                            </div>
                        </div>
                    </div>
