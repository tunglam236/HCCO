                              ...
                              <div class="random_products_slider box-module">
                                 <div class="row_items">
                                    ...
                                    <div class="item">
                                       <div class="item-inner">
                                          <div class="images-container">
                                             <a class="product-image" href="index.php-route=product-product-product_id=91.htm">
                                          ...
                                          <div class="des-container">
                                             <h2 class="product-name">
                                                <a href="index.php-route=product-product-product_id=91.htm">Crown Summit Backpacks</a>
                                             </h2>
                                             <div class="price-box box-regular">
                                                <span class="regular-price">
                                    ...
                                    <div class="item">
                                       <div class="item-inner">
                                          <div class="images-container">
                                             <a class="product-image" href="index.php-route=product-product-product_id=93.htm">
                                          ...
                                          <div class="des-container">
                                             <h2 class="product-name">
                                                <a href="index.php-route=product-product-product_id=93.htm">Endeavor Daytrip Backpacks</a>
                                             </h2>
                                             <div class="price-box box-regular">
                                                <span class="regular-price">
                                                <span class="price">$98.00</span>
                                    ...
                                    <div class="item">
                                       <div class="item-inner">
                                          <div class="images-container">
                                             <a class="product-image" href="index.php-route=product-product-product_id=98.htm">
                                          ...
                                          <div class="des-container">
                                             <h2 class="product-name">
                                                <a href="index.php-route=product-product-product_id=98.htm">Radiant Tees</a>
                                             </h2>
                                             <div class="price-box box-regular">
                                                <span class="regular-price">
                                 ...
                                 <div class="row_items">
                                    <div class="item">
                                       <div class="item-inner">
                                          <div class="images-container">
                                             <a class="product-image" href="index.php-route=product-product-product_id=101.htm">
                                          ...
                                          <div class="des-container">
                                             <h2 class="product-name">
                                                <a href="index.php-route=product-product-product_id=101.htm">Sprite Yoga Companion Kits</a>
                                             </h2>
                                             <div class="price-box box-regular">
                                                <span class="regular-price">
                                                <span class="price">$98.00</span>
