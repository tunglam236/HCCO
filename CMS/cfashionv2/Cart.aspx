...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    <div class="title-category" style="margin-bottom:0px;">
        <div class="container">
                                                                    ...
                                                                    <tr id="cartrows<%=i %>">
                                                                        ...
                                                                        <td class="text-left" style="line-height: 30px;">
                                                                            <span>Mã sản phẩm:
                                                                                ...
                                                                                <br />
                                                                            <a href='/<%=getRefMember() %>detail/<% =loadCart().Rows[i]["ID"].ToString()%>/<%=loadCart().Rows[i]["ProductName"].ToString().Replace(" ","-").Replace("?","-") %>.html'>
                                                                                <%=loadCart().Rows[i]["ProductName"].ToString() %>
                                                                            </a>
                                                                        </td>
                                                                        <td class="text-center">
                                                                             <%=loadCart().Rows[i]["ColorName"].ToString() %>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <%=loadCart().Rows[i]["SizeName"].ToString() %>
                                                                        </td>
                    ...
                    if (data.d.Isusing) {
                        ...
                        if (parseFloat(data.d.MinOrder) <= parseFloat($("#cph_hdPriceNotSale").val())) {
                            ...
                            if (data.d.isType == 2) {
                                ...
                                $("#discountvalue").text(numberWithCommas(parseInt((parseInt($("#cph_hdPriceNotSale").val().replace(/,/g, '')) * data.d.isValue) / 100)));
