                                                ...
                                                <div class="toolbar toolbar-products" style="margin: 10px;">
                                                    <div class="toolbar-amount">
                                                        CHI NHÁNH » <span style="font-weight: bold;">
                                                            <label id="lbBranchName" runat="server" style="font-weight:bold;">CN 421 Kim Mã - Hà Nội</label>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="custom-products quickview-add">
                                                    <div class="row mb">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <label id="lbAdd" runat="server">421 Kim Mã - Hà Nội</label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb">
                                                        <div class="col-md-3 col-sm-3 col-xs-12 br">
                                                    ...
                                                    <div class="row mb">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <label id="lbPhone" runat="server">024 22 18 95 95 </label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb">
                                                        <div class="col-md-3 col-sm-3 col-xs-12 br">
                                                            <i class="fa fa-facebook-square"></i><b> Facebook</b>
                                                        </div>
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <label id="lbFax" runat="server"><a target="_blank" href="http://facebook.com/cfashionvn"> http://facebook.com/cfashionvn </a></label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb">
    ...
    <script type="text/javascript">
        ...
        function initMap(districtId, branchId) {
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 17,
                center: new google.maps.LatLng(21.030451, 105.814977)
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        infoWindow.setContent('Địa chỉ: ' + data.d[i].Add + '<br />Số điện thoại: ' + data.d[i].Phone + '<br />Thời gian mở cửa: ' + data.d[i].Time);
