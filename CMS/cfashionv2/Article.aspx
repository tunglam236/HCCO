<%@ Page Title="" Language="C#" MasterPageFile="~/Child.master" AutoEventWireup="true" CodeFile="Article.aspx.cs" Inherits="Article" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    <div class="news-category">
        <div class="container">
            ...
            <h2 class="category-name">Giới thiệu và chính sách</h2>
                <ul class="breadcrumb">
                    <li><a href="/home">Trang chủ</a></li>
                    <li><a href="/home">C'Fashion</a></li>
                    <li>
