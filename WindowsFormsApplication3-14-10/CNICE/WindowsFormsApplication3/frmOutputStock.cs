                ...
                try
                {
                    ...
                    if (d.Count() > 0)
                    {
                        if (d.FirstOrDefault().Price > 0)
                        {
                            ...
                            dr["ProductName"] = d.FirstOrDefault().ProductName + " - " + d.FirstOrDefault().BrandName + " - " + d.FirstOrDefault().CountryName + " - " + d.FirstOrDefault().UnitName + " - " + d.FirstOrDefault().CapacityName;
                    ...
                    {
                        if (txtProductCode.Text.Trim().StartsWith("CB"))
