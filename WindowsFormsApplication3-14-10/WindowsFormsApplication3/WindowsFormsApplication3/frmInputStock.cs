...
namespace WindowsFormsApplication3
{
    public partial class frmInputStock : Office2007Form
    {
        ...
        private void txtStockOutputCode_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtStockOutputCode_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                var d = db.sp_StockInput_Get(WindowsFormsApplication3.Form1.branch_id, WindowsFormsApplication3.Form1.branch_type_id, txtStockOutputCode.Text.Trim());
                dtTemp.Rows.Clear();
