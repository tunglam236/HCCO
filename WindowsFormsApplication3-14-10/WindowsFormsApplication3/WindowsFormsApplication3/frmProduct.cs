...
namespace WindowsFormsApplication3
{
    public partial class frmProduct : Office2007Form
    {
        ...
        private void resetControl()
        {
            ...
            dgvProduct.DataSource = db.sp_Product_Search(WindowsFormsApplication3.Form1.branch_type_id,0,"");
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            dgvProduct.DataSource = db.sp_Product_Search(WindowsFormsApplication3.Form1.branch_type_id,
        ...
        private void dgvProduct_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvProduct.Rows.Count != -1 && e.RowIndex != -1)
            {
                ...
                code_cur = dgvProduct.Rows[e.RowIndex].Cells["CodeId"].Value.ToString();
            }
        }
