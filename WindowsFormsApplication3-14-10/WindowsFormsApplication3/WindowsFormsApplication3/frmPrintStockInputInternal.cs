...
{
    public partial class frmPrintStockInputInternal : Office2007Form
    {
        public frmPrintStockInputInternal()
        {
            InitializeComponent();
        }
        ...
        private void frmPrintStockInputInternal_Load(object sender, EventArgs e)
        {
